classdef Plot
    methods (Static, Access = public)
        function raster_plot_and_psth_of_spikes ( ...
            features, ...
            trials, ...
            feature_name, ...
            x_low_lim, ...
        ...
        function plot_lfp_hartley_stimulus_features ( ...
            continueous_data, ...
            ...
            for i = 1:numel(trials)
                trials_(i) = Experiments.Plot.extract_trial_contineous_data( ...
                                    trials(i), ...
                                    continueous_data, ...
                                    continueous_data_time, ...
                                    x_low_lim, ...
            ...
            for i = 1:numel(features)
                ...
                plot(trials_(1).continueous_data.time(1:29999), lfp, 'b');
                Utils.Plot.set_subplot_figure_design( ...
                                    x_low_lim, ...
                                    x_high_lim, ...
                                    min(lfp), ...
