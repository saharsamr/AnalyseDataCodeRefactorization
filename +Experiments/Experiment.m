classdef Experiment < AnalysisData.Data
    ...
    methods (Access = public)
        ...
        function extract_experiment_el_data (this, exp_index)
            ...
            [trials_start_indices, trials_end_indices] = ...
                        this.find_start_and_end_of_trials( ...
                                                    events_, ...
                                                    'trialNumber', ...
                                                    'reward:' ...
                        ) ...
            ...
            for trial_index = 1:numel(trials_start_indices)
                ...
                this.trials(trial_index).extract_trial_data( ...
                                                ...
                                                this.Properties, ...
                                                this.startDate, ...
                                                trials_start_indices(trial_index), ...
                                                trials_end_indices(trial_index), ...
                                                eye_time_samples, ...
                                                data_eye, ...
                                                start_time_eyelink ...
                );
                this.trials(trial_index).set_states_of_trail();
    ...
    methods (Access = protected)
        ...
        function [trials_start_indices, trials_end_indices] = ...
            find_start_and_end_of_trials (this, events_, start_keyword, end_keyword)

            trials_start_indices = Utils.Util.find_all(events_.info, start_keyword);
            trials_end_indices = Utils.Util.find_all(events_.info, end_keyword);

            num_of_trials = min(numel(trials_start_indices), numel(trials_end_indices));
            trials_start_indices = trials_start_indices(1:num_of_trials);
            trials_end_indices = trials_end_indices(1:num_of_trials);
        end
